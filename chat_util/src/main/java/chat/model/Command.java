...
public enum Command {
  SEND_MESSAGE("message"), LOGIN("username"), LOGIN_STATUS_OK("username"), LOGIN_STATUS_ERROR("status"), LOGOUT(
      "username"), NO_COMMAND(""), LOAD_HISTORY("date_from"), RESULT_STATUS_COMMAND("result_status");
