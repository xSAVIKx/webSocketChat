...
public class CommandMessageHandler implements MessageHandler {
	...
	public void handleMessage(CommandPojo message) {
		...
		case LOAD_HISTORY:
			...
			break;
		case LOGIN:
			printStream.printf(MESSAGE_FORMAT, timestamp, sender,
					String.format(LOGIN_MESSAGE_FORMAT, argumentValue)).flush();
			break;
		case LOGOUT:
			printStream.printf(MESSAGE_FORMAT, timestamp, sender,
					String.format(LOGOUT_MESSAGE_FORMAT, argumentValue))
					.flush();
			break;
		...
		case SEND_MESSAGE:
			printStream
					.printf(MESSAGE_FORMAT, timestamp, sender, argumentValue)
					.flush();
			break;
